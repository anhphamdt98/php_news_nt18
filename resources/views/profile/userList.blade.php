                                ...
                                <div class="col-2 profile-box border p-1 rounded text-center bg-light mr-4 mt-3">
                                    <div class="row" style="margin-bottom: 30px">
                                        ...
                                        <div class="col-md-3">
                                            <div class="row">
                                                <p class="mb-2">
                                                    <small>{{ trans('profile.followers') }} <span class="badge badge-primary tl-follower">{{ $other->followers()->get()->count() }}</span></small>
                                                </p>
                                            </div>
                                            <div class="row">
                                                <p class="mb-2">
                                                    <small>{{ trans('profile.following') }} <span class="badge badge-primary">{{ $other->following()->get()->count() }}</span></small>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
